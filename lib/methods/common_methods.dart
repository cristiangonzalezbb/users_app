...
class CommonMethods
{
  ...
  ///Calculo de costo del Viaje - Modificar
  calculateFareAmount(DirectionDetails directionDetails)
  {
    double distancePerKmAmount = 250;
    double durationPerMinuteAmount = 200;
    double baseFareAmount = 1000;
  ...
  return overAllTotalFareAmount.toStringAsFixed(0); //12.18 = 12.2
  }
}